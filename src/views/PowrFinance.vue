  ...
  <div>
      <div class="max-w-7xl mx-auto">
        ...
        <section class="max-w-7xl mx-auto py-20 px-16"> 
            ...
            <div class="flex space-x-6 mb-20">
                <div class="flex-1 border-dashed border-r border-brand-black-4">
                    ...
                    <p>Send mooney abroad to their clients using banks or 3rd party agents</p>
                </div>
                <div class="flex-1 border-dashed border-r border-brand-black-4">
                    <h3 class="mb-4 text-4xl lg:text-7xl font-semibold">55%</h3>
                    <p class="mb-2 font-bold">Of business men</p>
                    <p>Prefer receiving their payment in cryptocurrency from clients</p>
                </div>
                <div class="flex-1 border-brand-black-4">
                    <h3 class="mb-4 text-4xl lg:text-7xl font-semibold">63%</h3>
                    <p class="mb-2 font-bold">Of business men</p>
                    <p>Receive cash from customers and need a way  to transfer cash abroad</p>
                </div>
            </div>
            <div>
                <h4 class="text-2xl lg:text-3xl font-bold font-playfair">Major Pain Point</h4>
                <p class="mb-8">Two of the major painpoints that some users faced are stated below </p>
                <div class="mb-8">
                    <ul class="flex space-x-6 mb-8">
                        <li>You can only pay by bank transfer, debit card, or credit card — you can’t fund your transfer with cash or a cheque.</li>
                        <li>Most apps don’t support all currencies or provide transfers into all countries.</li>
                    </ul>
                    <ul class="flex space-x-6">
                        <li>Inability to make offline transactions for business that have just cash, i would have to go to the bank to first credit my account</li>
                        <li>Sometimes i might need some cash leverage on some purcases i want to make that i do not have enough funds for</li>
                    </ul>
                </div>
            </div>
        </section>
        <section>
            <div class="flex items-center justify-center h-screen max-w-7xl mx-auto text-6xl lg:text-7xl font-semibold bg-business bg-cover bg-center bg-no-repeat text-white">
                <h1>Business Opportunities</h1>
            </div>
        </section>
        <section class="max-w-7xl mx-auto py-20 px-16">
            <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Opportunities in Africa</h4>
            <p class="mb-4">With over 1.216 billion population 20% under 30 population of the growing economy., each one mobile tech savvy has at one point or another had reasons to make transfer or receive transfers from foreign parties</p>
            <p class="mb-4">Retailers, Individuals & MSMEs want more. The majority of consumers are underserved.</p>
            ...
            <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1"><img src="../assets/opportunities-graph-1.png" alt="Opportunities graph"></div>
                <div class="flex-1 ">
                    <h4 class="mb-4 text-2xl lg:text-3xl font-bold">45.6 Billion in total transactions in Africa</h4>
                    <p>Our first targets would be the top 5 countries with the highest remittance valueNigeria, Kenya and Ghana.</p>
                </div>
            </div>
            <p class="mb-8">With the pain points of users requesting payment in crypto currency, it opens up a new market to explore and that would mean another fast growing resource to tap into</p>
            <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1 ">
            ...
            <div class="mb-10">
                <h4 class="mb-4 text-2xl lg:text-3xl font-bold">Value Proposition - Customers Profile</h4>
                <p>In the customer's profile you describe the job your customer is trying to get done by highlighting customers pains and gains, it's used to track users needs and position the company’s to know more about the customers needs to properly create value</p>
                <div><img src="../assets/value-proposition-customer.png" alt="Value Proposition"></div>
            </div>
            <div class="mb-10">
                <h4 class="mb-4 text-2xl lg:text-3xl font-bold">Value Proposition - Value Map</h4>
                <p>Here you list the products and services your value proposition build on, describing in which way the product features and services are pain relievers an outline how they are gain creators</p>
                <div><img src="../assets/value-proposition-map.png" alt="Value Proposition"></div>
            </div>
        </section>
        <section>
            <div class="flex items-center justify-center h-screen max-w-7xl mx-auto text-6xl lg:text-7xl font-semibold bg-solutions bg-cover bg-center bg-no-repeat text-white">
                <h1>The Solutions</h1>
            </div>
        </section>
        <section class="max-w-7xl mx-auto py-20 px-16">
            <div class="mb-10">
                <h4 class="mb-4 text-2xl lg:text-3xl font-bold">Value Proposition - Value Map</h4>
                <p>The onboarding is the first point of contact of the user to the product, so it has to seamlessly convey the message and value proposition of the product cleanly and simply, and to ensure onboarding is fast, we take just the bare minimum to open a local account with a limited transaction limit to ensure transactions can be carried out, then to make higher transactions a KYC process has to be carried out.</p>
                <div><img src="../assets/onboarding-screens.png" alt="Onboarding Screens"></div>
            </div>
            <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1">
                    <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Create Bank Accounts</h4>
                    <p>Have access to creating a bank account for all the major currencies in the world, these bank accounts would be used to receive money from foreign clients by just sending them the account number</p>
                </div>
                <div class="flex-1"><img src="../assets/create-bank-account.png" alt="Create bank account"></div>
            </div>
             <div class="mb-10">
                <h4 class="mb-4 text-2xl lg:text-3xl font-bold">Send Money</h4>
                <p>You can send money to one person or multiple people at a time by selecting the person or people, specifying the transfer amount and currency, and inputting the various bank details. When you send all currencies are converted to USDT as a stable coin and that USDT can be liquidated into any currency of the receiver, hence making transfers done in minutes instead of days</p>
                <div><img src="../assets/send-money.png" alt="Send Money"></div>
            </div>
            <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1"><img src="../assets/crypto-payments.png" alt="Crypto payments"></div>
                <div class="flex-1">
                    <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Crypto Payments</h4>
            ...
            <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1">
                    <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Lending / Leveraging</h4>
                    <p>Every user has a credit capacity/ credit score and that is decided by the platform, in which the credit score is decided from your transaction history carried out on Powr finance. These credits can be used to make purchases or run businesses but are disbursed only with proof of utilization.</p>
                </div>
                <div class="flex-1"><img src="../assets/lending.png" alt="Lending and Leverage"></div>
            </div>
             <div class="flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
                <div class="flex-1"><img src="../assets/dollar-cards.png" alt="Dollar master card"></div>
                <div class="flex-1">
                    <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Dollar Master Cards</h4>
        ...
        <section class="max-w-7xl mx-auto">
            <div class="h-screen"><img src="../assets/more-features.png" alt="More Features"></div>
        </section>
        <section class="max-w-7xl mx-auto py-20 px-16">
            <h4 class="mb-4 text-2xl lg:text-3xl font-bold font-playfair">Conclusion</h4>
