  ...
  <div>
      <div class="max-w-7xl mx-auto">
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
            ...
            <div class="hidden md:flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
            ...
            <!-- Mobile version -->
            <div class="block md:hidden mb-10 bg-brand-black-3 text-white">
                <div class="mb-12">
            ...
            <div class="hidden md:flex items-center space-x-6 mb-10 bg-brand-black-3 text-white">
             ...
             <!-- Mobile version -->
            <div class="block md:hidden mb-16 bg-brand-black-3 text-white">
                <div class="mb-12">
