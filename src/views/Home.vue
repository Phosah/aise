<template>
    <div class="relative flex justify-center">
        <!-- Sidebar -->
        <div class="fixed">
            <div class="bg-red-200"><img class="w-16 lg:w-20" src="../assets/logo-dark.png" alt="Aise Logo"></div>
        </div>
        <!-- Main -->
        ...
        <!-- Sidebar -->
        <div class="fixed">
            <div class="absolute bg-green-300"><img class="w-16 lg:w-20" src="../assets/menu-icon-dark.png" alt="Menu toggle icon"></div>
        </div>
    </div>
</template>
