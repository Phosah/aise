    ...
    <div>
            ...
            <div class="hidden md:block max-w-7xl mx-auto px-16">
                <div class="h-screen flex items-center space-x-16">
                    <div class="w-1/2 mb-12 md:mb-0">
                        <h1 class="mb-2 text-3xl md:text-5xl lg:text-6xl font-semibold font-playfair">A little dive</h1>
                        <h1 class="mb-8 text-3xl md:text-5xl lg:text-6xl font-semibold font-playfair">into Aise</h1>
                        <p class="mb-8 text-justify">I am an Experience designer who is passionate about solving problems and design solutions that has great impact on people's lives</p>
                    ...
                    <div class="w-2/3"><img class="w-full" src="../assets/aise-photo.png" alt="Aise Photo"></div>
                </div>
            </div>
            <!-- Mobile version -->
            <div class="block md:hidden max-w-7xl mx-auto py-20">
                <div class="mb-12 px-4"><img class="w-full" src="../assets/aise-photo.png" alt="Aise Photo"></div>
                <div class="px-16">
                    <div class="">
                        <h1 class="mb-2 text-3xl md:text-5xl lg:text-6xl font-semibold font-playfair">A little dive</h1>
                        <h1 class="mb-8 text-3xl md:text-5xl lg:text-6xl font-semibold font-playfair">into Aise</h1>
                        <p class="mb-8 text-justify">I am an Experience designer who is passionate about solving problems and design solutions that has great impact on people's lives</p>
                        <div>
                            <button class="w-full mb-4 p-3 bg-white text-brand-black-1 font-semibold">Book an appointment</button>
                            <button class="w-full p-3 border border-white bg-brand-black-1 text-white font-semibold">Resume</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="max-w-7xl mx-auto py-20 px-16">
            <div class="max-w-5xl mx-auto md:px-16">
                ...
                <p class="md:w-4/5 lg:w-5/6 md:text-lg lg:text-xl md:leading-8">When I'm not designing, you can find me playing PC games, watching a movie (series preferably), I am always on my headset listening to good music. Through my design journey, I’ve found myself learning a bit of motion design, 3D design, front-end, and communication skills.</p>
            </div>
        </section>
        <section class="bg-brand-black-1 text-white">
            <div class="max-w-7xl mx-auto px-4 md:px-16 py-20 ">
                <h2 class="guideline-header  mb-8 text-4xl md:text-6xl lg:text-7xl xl:text-8xl text-transparent">MY DESIGN GUIDELINES</h2>
...
export default {
    name: 'Home',
    components: {DesignGuidelines, Footer },
    data() {
        return {
            guidelines: [
                {
