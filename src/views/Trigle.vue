  ...
  <div class="text-brand-black-4">
        ...
        <section class="hidden md:block max-w-7xl mx-auto py-20 px-16">
            <div class="flex items-center justify-between space-x-10 mb-16">
                ...
                <div class="w-2/3">
                    <h3 class="mb-4 text-3xl lg:text-5xl font-bold font-playfair">Farida Alasha</h3>
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
            ...
            <div class="hidden md:flex items-center justify-center space-x-14 w-2/3 mx-auto my-8">
