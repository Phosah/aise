    ...
    <div>
        <div class="dark:bg-brand-black-1 text-brand-black-4 dark:text-white">
            ...
            <section class="max-w-7xl mx-auto md:px-16 pt-4">
                <div class="header-box md:flex md:items-center md:justify-between mb-10 py-20 md:py-0 px-14 md:px-0 bg-hero-image bg-no-repeat bg-cover bg-brand-orange-1 text-white">
            ...
            <section class="max-w-7xl mx-auto px-4 md:px-16 py-20">
                <div class="hidden md:flex items-center justify-between space-x-12">             
                    ...
                    <div class="flex-1">
                        <img class="w-full" src="../assets/trigle-problem.png" alt="Guys and lady smiling and operating their mobiles.">
                    </div>
                </div>
                <!-- Mobile version -->
                ...
                <div class="md:flex md:items-center md:justify-between md:space-x-12">                
                    ...
                    <div class="flex-1 text-sm md:text-base">
                        ...
                        <ul class="mb-16 list-disc list-inside">
                            <li class="px-2">Knowledge of a handful of restaurants websites or apps to order meals from</li>
                            <li class="px-2">Humans always want to try out new things and being restricted to restaurants you know restricts that</li>
                            <li class="px-2">There is also a high need for a change of environment to clear the head or have a nice time with friends or loved ones which requires you to go physically to the restaurants</li>
                        </ul>
                        <p class="mb-6">With Trigle having its logistics services small restaurants have nothing to worry about not being able to deliver meals fast as that was their major concern</p>
                    ...
                    <div class="md:flex-1">
                        ...
                        <div class="">
                            <div class="flex items-center space-x-2 w-7/12 mb-4">
                                <p>2017</p>
                                <div class="flex justify-end py-2 px-3 bg-brand-gray-light-2 dark:bg-brand-gray-dark-1 w-full font-semibold rounded-md">$337</div>
                            </div>
                            ...
                            <div class="flex items-center space-x-2 w-10/12 mb-4">
                                <p>2025</p>
                                <div class="flex justify-end py-2 px-3 bg-brand-gray-light-2 dark:bg-brand-gray-dark-1 w-full font-semibold rounded-md">$470</div>
                            </div>
                            <div class="flex items-center space-x-2 mb-4">
                                <p>2030</p>
                                <div class="flex justify-end py-2 px-3 bg-brand-gray-light-2 dark:bg-brand-gray-dark-1 w-full font-semibold rounded-md">$650</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
                ...
                <div class="hidden md:flex items-center justify-center space-x-16 w-2/3 mx-auto mt-10">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
                <div class="md:flex md:items-center md:justify-between md:space-x-12 text-sm md:text-base">
                    ...
                    <div class="md:flex-1"><img class="mx-auto md:w-full" src="../assets/success-1.png" alt="Success"></div>
                </div>
            </section>
