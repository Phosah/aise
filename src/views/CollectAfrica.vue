        ...
        <div class="dark:bg-brand-black-1 text-brand-black-4 dark:text-white">
                    ...
                    <div class="p-8 rounded-lg bg-brand-gray-light-2 text-brand-black-2">
                        <div class="min-h-64 bg-contain bg-center bg-no-repeat">
                            <div>
                                <img
                                    class="w-full"
                                    src="../assets/process-research.png"
                    ...
                    <div class="p-8 rounded-lg bg-brand-gray-light-2 text-brand-black-2">
                        <div class="min-h-64 bg-contain bg-center bg-no-repeat">
                            <div>
                                <img
                                    class="w-full"
                                    src="../assets/process-analysis.png"
                    ...
                    <div class="p-8 rounded-lg bg-brand-gray-light-2 text-brand-black-2">
                        <div class="min-h-64 bg-contain bg-center bg-no-repeat">
                            <div>
                                <img
                                    class="w-full"
                                    src="../assets/process-ideation.png"
                    ...
                    <div class="p-8 rounded-lg bg-brand-gray-light-2 text-brand-black-2">
                        <div class="min-h-64 bg-contain bg-center bg-no-repeat">
                            <div>
                                <img
                                    class="w-full"
                                    src="../assets/process-feedback.png"
                    ...
                    <div class="p-8 rounded-lg bg-brand-gray-light-2 text-brand-black-2">
                        <div class="min-h-64 bg-contain bg-center bg-no-repeat">
                            <div>
                                <img
                                    class="w-full"
                                    src="../assets/process-iteration.png"
                ...
                <div class="md:flex md:items-center md:space-x-12">
                    <div class="md:flex-1 mb-8 md:mb-0">
                        ...
                        <ul class="list-disc pl-6">
                            <li
                                class="mb-2"
                            >Difficulties in verifying payments from customers when there is a delay in banks sending in the alert, especially from foreign transfers</li>
                            <li
                                class="mb-2"
                            >Difficulties in balancing your company account and keeping proper records that can be accessed anytime</li>
                            <li
                                class="mb-2"
                            >Difficulties in easily managing one company account across several branches of the same business</li>
                            <li class="mb-2">Difficulties in receiving foreign payments</li>
                            <li
                                class="mb-2"
                            >Difficulties in managing your business customers and maintaining a relationship</li>
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-20">
                    <h1
                        class="mb-6 text-4xl md:text-5xl lg:text-6xl font-semibold font-playfair"
                    >Value Proposition - Customers</h1>
                    <p
                        class="mb-14"
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
                ...
                <ul class="list-disc pl-6 text-xs">
                    <li
                        class="mb-2"
                    >As a user i want to be able to receive payments from my customers so i can get paid for my services</li>
                    <li
                        class="mb-2"
                    >As a user i want to be able to set reocurring payments for my customers</li>
                    <li
                        class="mb-2"
                    >As a user i want to be able to create paylinks that my customers would be able to pay into</li>
                    <li
                        class="mb-2"
                    >As a user i want to be able to fund my wallet in order to carry out transactions</li>
                    <li
                        class="mb-2"
                    ...
                    <li
                        class="mb-2"
                    >As a user i want to be able to receive payments with multiple payment methods so users would always have a means to pay from</li>
            ...
            <section class="max-w-7xl mx-auto pt-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-20">
                    ...
                    <div class="mb-16">
                        <img
                            class="w-full"
                            src="../assets/onboarding-screens-2.png"
                ...
                <div class="md:flex md:items-center md:justify-between md:space-x-12 py-20">
                    ...
                    <div class="md:flex-1">
                        <img
                            class="w-full"
                            src="../assets/simplified-dashboard.png"
                ...
                <div class="hidden md:flex items-center justify-between space-x-12 py-20">
                    <div class="flex-1">
                        <img
                            class="w-full"
                            src="../assets/customer-management.png"
                            alt="Simplified dashboard"
                        />
                    </div>
                    <div class="flex-1">
                ...
                <div class="py-20">
                    ...
                    <div class="mb-16">
                        <img
                            class="w-full"
                            src="../assets/account-reconciliation.png"
            ...
            <section class="max-w-7xl mx-auto pt-20 px-4 md:px-16 text-sm md:text-base">
                <div class="md:flex md:items-center md:justify-between md:space-x-12 py-20">
                    ...
                    <div class="md:flex-1">
                        <img
                            class="w-full"
                            src="../assets/collect-conclusion.png"
