    ...
    <div class="text-brand-black-4">
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
            <div class="mb-8 text-center">
                <h2 class="mb-8 text-3xl md:text-6xl font-semibold font-playfair">Project Timeline</h2>
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-white bg-brand-black-4">
            <h2 class="mb-16 text-3xl md:text-6xl font-semibold font-playfair text-center">Personas</h2>
            <div class="lg:flex lg:space-x-14 lg:justify-center">
                <div class="sm:flex sm:space-x-6 mb-12 lg:mb-0">
                    <div class="sm:flex-1">
                        ...
                        <div class="sm:w-52 mb-4 p-4 rounded-md bg-brand-black-5 text-sm">Rarely use logistics services</div>
                        <div class="sm:w-52 mb-4 p-4 rounded-md bg-brand-black-5">
                ...
                <div class="sm:flex sm:space-x-6">
                    <div class="sm:flex-1">
                        ...
                        <div class="sm:w-52 mb-4 p-4 rounded-md bg-brand-black-5 text-sm">Very frequency in using logistics services</div>
                        <div class="sm:w-52 mb-4 p-4 rounded-md bg-brand-black-5">
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
            <h2 class="mb-8 text-3xl md:text-6xl font-semibold font-playfair text-center">Design strategy</h2>
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
            <h2 class="mb-8 text-3xl md:text-6xl font-semibold font-playfair text-center">The Solution</h2>
            <p class="mb-16 md:w-2/3 lg:w-2/4 mx-auto text-center text-center">Below shows a few of the screens that portrayed the soltions to the stated problem in the most user friendly manner</p>
            ...
            <!--  -->
            <div class="md:flex md:items-center md:justify-between md:space-x-12 mb-20 md:mb-0 md:py-20">
                <div class="md:flex-1 mb-12 md:mb-0">
        ...
        <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
            <h2 class="mb-8 text-3xl md:text-6xl font-semibold font-playfair text-center">Conclusion</h2>
