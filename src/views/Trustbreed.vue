    ...
    <div>
        <div class="dark:bg-brand-black-1 text-brand-black-4 dark:text-white">
            ...
            <section class="max-w-7xl mx-auto md:px-16 pt-4">
                <div class="header-box md:flex md:items-center md:justify-between mb-10 py-20 px-14 md:px-0  bg-hero-image bg-no-repeat bg-cover bg-brand-red-5 text-white">
                    <div class="flex-1 mb-8 md:mb-0 md:text-left text-center">
                        <div class="md:ml-16 md:pr-6">
                            <h2 class="mb-4 text-2xl md:text-3xl lg:text-5xl font-semibold font-playfair">TrustBreed</h2>
                            <p class="text-lg md:text-xl lg:text-3xl font-light">Customer Service, B2C</p>
                        </div>
                    </div>
                    <div class="flex-1">
            ...
            <section class="max-w-7xl mx-auto py-20 px-16">
                <div class="max-w-5xl mx-auto md:px-16">
                    <h1 class="mb-4 lg:mb-7 text-4xl md:text-5xl lg:text-6xl font-semibold font-playfair">TrustBreed</h1>
                    <p class="mb-14 md:text-lg lg:text-xl">As a customer, have your voice heard and get the best of services from the companies / products that serve you.</p>
                    <div class="mb-14 md:w-10/12 pl-6 border-l-4 border-brand-black-4 text-xl md:text-2xl lg:text-4xl font-bold leading-normal lg:leading-normal">
                        Trustbreed is a customer support tool to help users of any and every product get the best of services from their respective providers
                    </div>
                    <p class="md:w-4/5 lg:w-5/6 md:text-lg lg:text-xl md:leading-8">Trustbreed was born to help users/customers as a result of users being tired of receiving sub-standard services for their hard-earned money from products/companies they patronize to serve them.</p>
                </div>
            </section>
                ...
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-10 text-white text-sm md:text-base">
                    <div class="p-8 rounded-lg bg-brand-orange-6">
                        <div class="h-64 bg-one bg-contain bg-center bg-no-repeat">
                            ...
                            <ul class="list-disc pl-6">
                                <li class="mb-3">Problem Statement</li>
                                <li class="mb-3">UX Competitive Analysis</li>
                                <li>User Stories</li>
                            </ul>
                        </div>
                    </div>
                    <div class="p-8 rounded-lg bg-brand-blue-6">
                        <div class="h-64 bg-two bg-contain bg-center bg-no-repeat">
                            ...
                            <ul class="list-disc pl-6">
                                <li class="mb-3">Survey & interviews</li>
                                <li class="mb-3">User Persona</li>
                                <li class="mb-3">User Journey Map</li>
                                <li class="mb-3">Mental Models</li>
                    ...
                    <div class="p-8 rounded-lg bg-brand-green-4">
                        <div class="h-64 bg-three bg-contain bg-center bg-no-repeat">
                            <h3 class="text-lg md:text-xl lg:text-2xl mb-6 font-bold font-playfair">Ideate</h3>
                            <ul class="list-disc pl-6">
                                <li class="mb-3">Sitemap</li>
                    ...
                    <div class="p-8 rounded-lg bg-brand-red-4">
                        <div class="h-64 bg-four bg-contain bg-center bg-no-repeat">
                            <h3 class="text-lg md:text-xl lg:text-2xl mb-6 font-bold font-playfair">Usability Testing</h3>
                            <ul class="list-disc pl-6">
                                <li class="mb-3">Test Plan</li>
                                <li class="mb-3">Test Script</li>
                    ...
                    <div class="h-80 p-8 rounded-lg bg-brand-purple-4">
                        <div class="h-64 bg-five bg-contain bg-center bg-no-repeat">
                            ...
                            <ul class="list-disc pl-6">
                                ...
                                <li class="mb-3">Evaluating the Design for Accessibility</li>
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 bg-brand-black-1 text-white text-sm md:text-base">
                <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">UX competitive analysis</h2>
                <p class="mb-10">I was given two potential competitors by the founders and stakeholders began my study on them and built their marketing profile, SWOT profile, and conducted a UX analysis of their products. The goal was to identify what type of problems users face with competitors’ products, as well as understand what the users might expect from my product.</p>
                <div class="mb-16"><img class="w-full" src="../assets/ux-competition-analysis-1.png" alt=""></div>
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="md:w-2/3 mb-12">
                    ...
                    <p>The user stories capture feelings, needs, and expectations of potential users toward creating solutions properly tailored to meet users needs</p>
                </div>
                <div>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">Mental models and user journey map</h2>
                <p class="mb-6">To understand better the challenges surfers are facing in diﬀerent situations, based on the needs and goals of my personas, I created Mental Models and User Journey Maps.</p>
            ...
            <section class="">
                <div class="max-w-7xl mx-auto pt-20 px-4 md:px-16 text-sm md:text-base">
                    ...
                    <p class="mb-8 md:mb-16">After that, I started creating wireframes with pen and paper. Having the hand-drawn screens, I made a low-ﬁdelity prototype putting them together to represent the user ﬂow.</p>
                </div>
                <div class="max-w-7xl mx-auto mb-20"><img src="../assets/wireframe.png" alt="Wireframe"></div>
            </section>
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-20">
                    <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">Onboarding Screens </h2>
                    <p class="mb-10">Tailoring the onboarding to a simple clean visual experience where the users can join the trustbreed using just their name, email and get security authentication through an OTP code. Users are also able to choose or create a customized username.</p>
                ...
                <div class="md:flex md:items-center md:justify-between md:space-x-12 py-20">
                    <div class="md:flex-1">
                        <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">Complaints screens</h2>
                ...
                <div class="pt-20">
                    ...
                    <p class="mb-10">A lot of users are on the lookout for the best product for their needs, due to the long list of competitors for popular services the best is a bit tricky to pick, hence trustbreed gives you the ability to compare companies based on data, and other users ratings and reviews.</p>
            ...
            <section class="text-sm md:text-base">
                <div class="max-w-7xl mx-auto pt-20 px-4 md:px-16">
                    ...
                    <p class="mb-10">There are a couple more features like the reviews feature which helps other users know how well you think about a company in case they are surfing for a product to use, the rating feature, and the company activities feature to help be in sync with the upcoming promos or packages companies you follow are bringing out</p>
                </div>
                <div class="max-w-7xl mx-auto mb-20"><img src="../assets/other-features.png" alt="User flows"></div>
                <div class="max-w-7xl mx-auto pt-20 px-4 md:px-16">
                    <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">Mobile responsiveness</h2>
                    <p class="mb-10">90% of the target users are mobile users and hence to maximize the experience of users, there needs to be a lot of attention paid to the mobile views of the dashboard as that might be the main entry point of most users</p>
                </div>
                <div class="max-w-7xl mx-auto mb-20"><img src="../assets/mobile-responsive-photo.png" alt="User flows"></div>
            </section>
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-16">
                    <h2 class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair">Usability Testing</h2>
                    <p class="mb-6">I wanted to observe and measure if users understand the product, its value, and how to complete basic functions through testing the high-ﬁdelity prototype. Below were the test objectives;</p>
            ...
            <section class="flex flex-col items-center max-w-7xl mx-auto py-20 md:px-16">
                ...
                <div class="md:w-5/6 mx-auto px-16 md:px-0">
                    <h3 class="mb-8 sm:text-4xl md:text-5xl lg:text-7xl text-center font-semibold font-playfair">Let's talk about your project</h3>
                ...
                <button class="px-8 py-6 font-bold rounded-sm text-white
                dark:text-brand-black-1 bg-brand-black-1 dark:bg-white">Book an appointment</button>
            </section>
            <FooterDark />
        </div>
    </div>
