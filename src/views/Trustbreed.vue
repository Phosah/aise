        ...
        <div class="dark:bg-brand-black-1 text-brand-black-4 dark:text-white">
            ...
            <section class="max-w-7xl mx-auto py-20 px-16">
                <div class="max-w-5xl mx-auto md:px-16">
                    ...
                    >As a customer, have your voice heard and get the best of services from the companies / products that serve you.</p>
                    <div
                    ...
                    >Trustbreed is a customer support tool to help users of any and every product get the best of services from their respective providers</div>
                    <p
                ...
                >
                    ...
                    <div class="h-80 p-8 rounded-lg bg-brand-purple-4">
                        <div class="h-64 bg-five bg-contain bg-center bg-no-repeat">
                            <h4
                                class="text-lg lg:text-2xl mb-6 font-bold font-playfair"
                            >Visual Design</h4>
                            <ul class="list-disc pl-6">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16">
                ...
                >
                    <div class="md:flex-1 mb-10 md:mb-0">
                        ...
                        <p
                            class="mb-6"
                        >As a user / a customer, you have just one reason for patronizing a product or a service, and the result is the solution to their problems which results in user satisfaction.</p>
                        <p
                            class="mb-6"
                    ...
                    <div class="md:flex-1">
                        <img
                            class="w-full"
                            src="../assets/problem-statement-photo.png"
                            alt="Problem fixing"
                        />
                    </div>
                </div>
            ...
            >
                <h2
                    class="mb-6 text-2xl md:text-3xl lg:text-4xl font-bold font-playfair"
                >UX competitive analysis</h2>
                <p
                    class="mb-10"
                >I was given two potential competitors by the founders and stakeholders began my study on them and built their marketing profile, SWOT profile, and conducted a UX analysis of their products. The goal was to identify what type of problems users face with competitors’ products, as well as understand what the users might expect from my product.</p>
                <div class="mb-16">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                ...
                <div>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to make a complaint about a company that I patronized so my issue can be resolved</li>
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to add a company that is not listed on the platform that I want to make a complaint about</li>
                    </ul>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
                        <li
                            class="flex-1 mb-8"
                        >As a user i want to be able to leave a good review about a company that served me well so others can know and also patronize them</li>
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to check the companies that have been listed on trustbreed and give ratings to them so people know how good or bad I feel about their services</li>
                    </ul>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to monitor my complaint to know the status of the resolution</li>
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to view the profile of companies to be able to see what they offer and what others feel about them</li>
                    </ul>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to engage a comment or review made by other users on a complaint I can relate with</li>
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to give responses to other users complaints in case i have the solution</li>
                    </ul>
                    <ul class="md:flex md:space-x-12 pl-5 list-disc">
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to compare companies of similar services so I know the best company to patronize</li>
                        <li
                            class="flex-1 mb-8"
                        >As a user, i want to be able to share my complaint and others complaints with my friends on social media</li>
                    </ul>
                </div>
            </section>
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
            ...
            <section class="max-w-7xl mx-auto py-20 md:px-16 text-sm md:text-base">
                ...
                <div class="md:flex md:space-x-12 mb-28">
                    ...
                    <div class="md:w-2/3 px-4">
                        ...
                        <p
                            class="mb-8"
                        >Jasmine is a 37yrs old project manager who always has to be online due to the remote nature of her job. She works from 9 to 5 from Mondays to Fridays and has a couple of side projects over the weekend</p>
                        <h3
                            class="mb-3 text-lg md:text-xl lg:text-2xl font-bold font-playfair"
                        >Behaviour & Attitude</h3>
                        <p
                            class="mb-8"
                        >She is calm and collected, patient and like things done quickly as she believes time is precious and should be properly utilized</p>
                        <h3
                            class="mb-3 text-lg md:text-xl lg:text-2xl font-bold font-playfair"
                        >Goals</h3>
                        <p
                ...
                <div class="md:flex md:space-x-12">
                    ...
                    <div class="md:w-2/3 px-4">
                        ...
                        <p
                            class="mb-8"
                        >Richard is a 24yrs old Engineer, he spends a lot of time reading articles and making online purchases for his hardware and engineering materials to be able to work properly</p>
                        <h4
                            class="mb-3 text-lg md:text-xl lg:text-2xl font-bold font-playfair"
                        >Behaviour & Attitude</h4>
                        <p
                            class="mb-8"
                        >He is calm, intelligent and a bit hyper active at his actions</p>
                        <h4
                            class="mb-3 text-lg md:text-xl lg:text-2xl font-bold font-playfair"
                        >Goals</h4>
                        <p
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-20">
                    ...
                    <p
                        class="mb-10"
                    >Tailoring the onboarding to a simple clean visual experience where the users can join the trustbreed using just their name, email and get security authentication through an OTP code. Users are also able to choose or create a customized username.</p>
                    <div class="mb-16">
                        <img
                            class="w-full"
                            src="../assets/onboarding-screen.png"
                ...
                <div class="md:flex md:items-center md:justify-between md:space-x-12 py-20">
                    <div class="md:flex-1">
                        ...
                        <p
                            class
                        >The complaint creation is the centerpiece of the product whereby every user can come into trustbreed and make a complaint about a company that has rendered them poor service. If the company doesn’t exist on trustbreed, you can create them and the company is verified before finally listed. Every complaint submitted would be followed up by trustbreeds agents till the issue is resolved through constant communication with the company and the users</p>
                    </div>
                    <div class="md:flex-1">
                        <img
                            class="ml-auto"
                            src="../assets/complaint-screen.png"
                ...
                <div class="pt-20">
                    ...
                    <p
                        class="mb-10"
                    >A lot of users are on the lookout for the best product for their needs, due to the long list of competitors for popular services the best is a bit tricky to pick, hence trustbreed gives you the ability to compare companies based on data, and other users ratings and reviews.</p>
                    <div class="mb-16">
                        <img
                            class="w-full"
                            src="../assets/compare-company.png"
                            alt="Compare company"
                        />
                    </div>
                </div>
            ...
            <section class="text-sm md:text-base">
                ...
                <div class="max-w-7xl mx-auto pt-20 px-4 md:px-16">
                    ...
                    <p
                        class="mb-10"
                    >90% of the target users are mobile users and hence to maximize the experience of users, there needs to be a lot of attention paid to the mobile views of the dashboard as that might be the main entry point of most users</p>
                </div>
                <div class="max-w-7xl mx-auto mb-20">
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                <div class="mb-16">
                    ...
                    <p
                        class="mb-6"
                    >I wanted to observe and measure if users understand the product, its value, and how to complete basic functions through testing the high-ﬁdelity prototype. Below were the test objectives;</p>
                ...
                >
                    ...
                    <div class="flex space-x-10 p-6 border-b border-gray-600">
                        ...
                        <p
                            class="flex-1"
                        >The four categories can be merged with one button that has a down showing all the actions that can be taken</p>
                    </div>
                    <div class="flex space-x-10 p-6">
                        ...
                        <p
                            class="flex-1"
                        >Addition of a video upload alongside the photo upload option</p>
                    </div>
                </div>
                <!-- Mobile version -->
                <div class="block md:hidden text-sm text-white">
                    ...
                    <div class="divide-y border-gray-600 rounded-lg bg-brand-black-5">
                        ...
                        <p
                            class="p-6"
                        >The categories could be redesigned to show just 4 categories and a dropdown showing more that reveals all the rest categories when clicked</p>
                        <p
                            class="p-6"
                        >The four categories can be merged with one button that has a down showing all the actions that can be taken</p>
            ...
            <section class="max-w-7xl mx-auto py-20 px-4 md:px-16 text-sm md:text-base">
                ...
                <p
                    class="md:mb-16"
                >Throughout the design process, I learned how to prioritize and be very careful in user experience in the product, a product that is built upon the basis of bad user experiences of other products, the user experience could not be compromised. I got the opportunity to. Thank you for following and going through my documented processes. Feel free to connect with me on LinkedIn, Behance, Dribbble, and Twitter.</p>
            </section>
            <section class="max-w-7xl mx-auto py-20 md:px-16">
                ...
                <!-- Mobile version -->
                <section
                    class="block md:hidden works-box mb-20 py-28 px-14 bg-hero-image bg-no-repeat bg-cover bg-brand-orange-1 text-white"
                >
